...
/* Loads/persists Musculação execution history via window.storage — mirrors
   running/useWorkouts.js. Sessions are append/delete only: a session is
   built up entirely in SessionRunner's local state and only reaches here
   once, when the workout is finished. */
