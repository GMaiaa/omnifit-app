...
import { SpeedEvolutionCard } from "./SpeedEvolutionCard";
import { SpeedHrCard } from "./SpeedHrCard";
...
export function AnalyticsTab({ workouts }) {
  ...
  if (workouts.length === 0) {
    return (
      <EmptyState
        ...
        description="Registre alguns treinos para desbloquear evolução de velocidade, consistência, recordes pessoais e comparação entre ciclos."
      />
    );
  }
  ...
  return (
    <div className="flex flex-col gap-5">
      <InsightsPanel workouts={workouts} speedWindowWeeks={windowWeeks} />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <div className="lg:col-span-2">
          <SpeedEvolutionCard workouts={workouts} typeId={activeType} windowWeeks={windowWeeks} />
        </div>
        <SpeedHrCard workouts={workouts} typeId={activeType} />
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <div className="lg:col-span-2">
          <ElevationCard workouts={workouts} windowWeeks={windowWeeks} />
        </div>
